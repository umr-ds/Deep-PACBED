...
This repository provides the trained models and the test data sets presented in the paper "Deep PACBED: Multitask Analysis of PACBED Images using Deep Neural Networks" (Schneider et al., 2026).
